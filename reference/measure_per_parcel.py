...
import pandas as pd
import numpy as np
from shared import set_environment, calculate_angle, drop_gdb_item_if_exists
...
def clip_streets_near_parcel(parcel_fc, parcel_id, street_fc, output_street_fc, buffer_ft=40):
    ...
    drop_gdb_item_if_exists(output_street_fc)
    drop_gdb_item_if_exists("parcel_buffer")
...
def populate_parallel_field(parcel_street_join_fc, parcel_line_fc, street_name_field, parallel_field, street_fc):
    ...
    drop_gdb_item_if_exists(parcel_street_join_fc)
...
def run(building_source_date, parcel_id, all_parcel_lines_fc):
    ...
    drop_gdb_item_if_exists(split_parcel_lines_fc)
...
if __name__ == "__main__":
    ...
    #run("20240107", 62, "parcel_lines_from_polygons")
    #run("20240107", 52, "parcel_lines_from_polygons")
    #run("20240107", 1295, "parcel_lines_from_polygons")
